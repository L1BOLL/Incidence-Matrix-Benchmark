...
def run_comprehensive_benchmark():
    ...
    # Load prior coeffs, calibrate on this machine, and persist
    runner.load_memory_coeffs()
    runner.calibrate_memory_models(directed=True)
    coeffs_path = runner.save_memory_coeffs()
    print(f"[mem] calibrated coefficients → {coeffs_path}")
